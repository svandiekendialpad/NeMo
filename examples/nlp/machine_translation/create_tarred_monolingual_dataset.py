...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--tokenizer_name', type=str, default='sentencepiece', help='Supports sentencepiece and HuggingFace tokenizers',
    )
    ...
    if args.tokenizer_name in ["sentencepiece"] and not os.path.exists(args.tokenizer_model):
