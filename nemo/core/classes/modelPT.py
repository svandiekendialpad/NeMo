        ...
        outputs: Union[List[Dict[str, torch.Tensor]], List[List[Dict[str, torch.Tensor]]]] = [
            {
                ...
                'val_wer_num': torch.tensor(0.0),
                'val_wer_denom': torch.tensor(0.0),
                'val_final_loss': torch.tensor(0.0),
                'val_inter_ctc_loss_l2': torch.tensor(0.0),
                'val_inter_ctc_loss_l4': torch.tensor(0.0),
                'val_inter_wer_l2': torch.tensor(0.0),
            }
        ]
